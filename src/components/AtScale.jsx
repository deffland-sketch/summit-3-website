...
const needs = [
  ...
  },
  {
    ...
    color: '#f6aa40',
    industrial: 'Age-based cohorts, shared schedules, extracurriculars. Community happens by proximity, not by design.',
    summit: 'Intentional community circles with a human guide who knows each student deeply. Peer groups built across ages and interests. Belonging is designed into the daily experience, not left to chance.',
  },
  {
    ...
    summit: 'Students are always within a safe, purposeful structure, but that structure is flexible. Architecting the system coordinates spaces, adults, and schedules so students move between experiences safely. Safety is maintained without rigidity.',
  },
  {
  ...
  },
  {
    ...
    summit: 'Four specialized capacities (guiding, providing content expertise, facilitating, and architecting the system) so adults can develop deep expertise. AI handles administrative load. The work is more engaging because educators do what they\'re best at.',
  },
]
      ...
      >
        ...
        <div className="p-5 pt-3">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <p className="text-[10px] font-bold text-black/30 tracking-wide mb-1.5">THE INDUSTRIAL MODEL</p>
              <p className="text-sm text-black/50 leading-relaxed">{need.industrial}</p>
            </div>
            <div className="rounded-lg p-3 -m-1" style={{ backgroundColor: need.color + '0a' }}>
              <p className="text-[10px] font-bold tracking-wide mb-1.5" style={{ color: need.color }}>SUMMIT 3.0</p>
              <p className="text-sm text-black/70 leading-relaxed font-[500]">{need.summit}</p>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <section className="py-20 md:py-28 px-6" style={{ backgroundColor: '#ebf5f0' }} ref={ref}>
      <div className="max-w-3xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-indigo mb-5">
            How the industrial model keeps winning — and why it will be different this time
          </h2>
        ...
        <motion.p
          ...
          className="text-center text-black/60 font-bold mt-12 text-sm"
        >
