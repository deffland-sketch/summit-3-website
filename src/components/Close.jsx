    ...
    >
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          ...
          That's been Summit's vision since 2003. For the first time, we have the
          tools, the team, and the track record to build the school that vision
          always demanded. We're inviting you to invest in the proof point.
        </motion.p>
